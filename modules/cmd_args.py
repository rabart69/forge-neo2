...
parser.add_argument("--administrator", action="store_true", help="Administrator rights", default=True)
...
parser.add_argument("--no-hashing", action="store_true", help="disable sha256 hashing of checkpoints to help loading performance", default=True)
